 ...
 <div class="container-fluid">
        ...
        <div class="container">
                <div class="row">
                  ...
                  <div class="col-lg-2 col-md-3 col-sm-3" style="border:2px solid red; padding: 5px; box-shadow: 2px 3px 8px 3px red; margin-bottom:25px;">
                    <a href="old_vyawasthashulk_list.html"><h2 style="color:blue;text-align:center;">पुरानी व्यवस्था सूची</h2></a>
                    <a href="old_vyawasthashulk_list.html"><h4 style="color:blue;text-align:center;"></h4></a>
                    <a href="old_vyawasthashulk_list.html"><h6 style="text-align:center;animation: animate 
                1.5s linear infinite;">(गूगल फार्म द्वारा)</h6></a>
                  </div>
                  <div class="col-lg-2 col-md-0 col-sm-1">
                  </div>
                  <div class="col-lg-2 col-md-2 col-sm-3" style="border:2px solid red; padding: 5px; box-shadow: 2px 3px 8px 3px red; margin-bottom:25px; ">
                    <a href="new_vyawasthashulk_list.html"><h2 style="color:blue; text-align:center;">व्यवस्था सूची</h2></a>
                    <a href="new_vyawasthashulk_list.html"><h4 style="color:blue;text-align:center;"> </h4></a>
                    <a href="new_vyawasthashulk_list.html"><h6 style="text-align:center;animation: animate 
                1.5s linear infinite;">(वेबसाइट द्वारा)</h6></a>
                  </div>
                  <div class="col-lg-2 col-md-2 col-sm-1">
                  </div>
                  <div class="col-lg-2 col-md-2 col-sm-3" style="border:2px solid red; padding: 5px; box-shadow: 2px 3px 8px 3px red ">
                    <a href="updated_vyawasthashulk_list.html"><h2 style="color:blue;text-align:center;">नई व्यवस्था सूची</h2></a>
                    <a href="updated_vyawasthashulk_list.html"><h4 style="color:white;text-align:center;"> .</h4></a>
                    <a href="updated_vyawasthashulk_list.html"><h6 style="text-align:center;animation: animate 
                1.5s linear infinite;">Click Here</h6></a>
                  </div>
                  <div class="col-lg-1 col-md-1 col-sm-1" style="margin-bottom:100px;">
                  </div>
                </div>
              </div>
              ...
              <div class="container-fluid">
                <div class="row">
                  ...
                  <div class="col-lg-8">
                    ...
                    <div class="card-body" style="border: 2px dashed green;padding: 8px;box-shadow: 2px 3px 8px 3px green;">
                        <h2 style="color:blue;text-align:center">व्यवस्था शुल्क कभी भी जमा कर सकते है, यह जमा करने की तिथि से एक वर्ष तक के लिए मान्य रहेगा।</h2>
                      <h1 style="color:#3F3F97; text-align: center;font-size:20px;">Name :  TEACHERS SELF CARE SAMITI</h1>
                      <h1 style="color:#3F3F97; text-align: center;font-size:23px;">A/C – 39843815473</h1>
                      <h1 style="color:#3F3F97; text-align: center;font-size:23px;">IFSC- SBIN0001583</h1>
                      <p>व्यवस्था शुल्क जमा करने के बाद रसीद अवश्य अपलोड कर दें</p>
                      <p>लिंक-
                <a href="teacher/login.html?donate=1"><button class="btn btn-primary" style="text-align:center">upload vyawstha shulk receipt</button></a><br>
                </p>
                <h3 style="text-align:center">TSCT हेल्पलाइन- किसी भी समस्या के लिए पहले अपनी जिला टीम से सम्पर्क करेगे, उसके बाद आवश्यकता पड़े तो दिन में 10बजे से 1 बजे तक इस नम्बर पर काल कर सकते हैं- 7007087337</h3>
                    </div>
              ...
              <div class="container-fluid" style="overflow:scroll;margin-top:25px;">
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <!-- <h3 class="m-0 font-weight-bold text-primary">सहयोग सूची
              <a href="old_sahayogsuchi_list.html" style="margin-left:200px; color:red;">Click here to Old list</a> -->
              </h3>
            </div>
            <div class="card-body">
