...
</div>            <div class="container" style="color:#3F3F97;">
				<div class="row">
					<div class="col-12">
						<h2 class="contact-title" style="color:red;text-align: center;">Contact Us</h2>
					</div>
				</div>
				<br/>
                <div class="row">                    
					<div class="col-lg-8">
						<form class="form-contact contact_form" action="" method="post" id="contactForm" style="padding-left: 5px;padding-right: 5px;">
							<div class="row">
								<div class="col-lg-12">
							...
							<div class="row">
								...
								<div class="col-12">
									...
									<div class="form-group" style="border:2px dashed #3F3F97;">
										<input type="text" class="form-control w-100" name="name" id="name" placeholder=" Enter your Name" required>
									</div>
								</div>
								<div class="col-12">
									<div class="form-group">
										<input class="form-control w-100" name="subject" id="subject"  onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Subject'" placeholder=" Enter Subject" required style="border:2px dashed #3F3F97;">
									</div>
								</div>
								<div class="col-12">
									<div class="form-group">
										<input type="number" class="form-control w-100" name="mobile" id="mobile"  onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your Mobile'" placeholder=" Enter your Mobile" required style="border:2px dashed #3F3F97;">
									</div>
								</div>
								<div class="col-12">
									<div class="form-group">
										<input type="email" class="form-control w-100" name="email" id="email"  onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your Email'" placeholder=" Enter your Email" required style="border:2px dashed #3F3F97;">
									</div>
								</div>
								<div class="col-12">
									<div class="form-group">
										<textarea class="form-control w-100" name="message" id="message"  onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Message'" placeholder=" Enter Message" style="border:2px dashed #3F3F97;"></textarea>
									</div>
								</div>
					...
					<div class="col-lg-3 offset-lg-1">
						...
						<!--</div>-->
						<div class="media contact-info">
							<span class="contact-info__icon"><i class="fa fa-tablet" style="color:#3F3F97;"></i></span>
							<div class="media-body">
								<h3>7007087337</h3>
						...
						<div class="media contact-info">
							<span class="contact-info__icon" ><i class="fa fa-envelope-o" style="color:#3F3F97;"></i></span>
							<div class="media-body">
								<h3>tsctcare@gmail.com</h3>
								<p style="color: red;">Send us your query anytime!</p>
							</div>
						</div>
					</div>
				</div>
