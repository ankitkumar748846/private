...
<div class="row" style="overflow: hidden;">
    <div class="navbar">
        ...
        <div class="container">
                <div class="row">
                  ...
                  <div class="col-lg-2 col-md-3 col-sm-3" style="border:2px solid red; padding: 5px; box-shadow: 2px 3px 8px 3px red; margin-bottom:25px;">
                    <a href="old_sahyogsuchi_list_common_header.html"><h2 style="color:blue;text-align:center;">पुरानी सहयोग सूची</h2></a>
                    <a href="old_sahyogsuchi_list_common_header.html"><h4 style="color:blue;text-align:center;">(सहयोग 2 से 132 तक)</h4></a>
                    <a href="old_sahyogsuchi_list_common_header.html"><h6 style="text-align:center;animation: animate 
                1.5s linear infinite;">Click Here</h6></a>
                  </div>
                <!--  <div class="col-lg-1 col-md-0 col-sm-1">-->
                <!--  </div>-->
                <!--  <div class="col-lg-2 col-md-3 col-sm-3" style="border:2px solid red; padding: 5px; box-shadow: 2px 3px 8px 3px red; margin-bottom:25px;">-->
                <!--    <a href="new_sahyogsuchi_list.html"><h2 style="color:blue;text-align:center;">सहयोग सूची</h2></a>-->
                <!--    <a href="new_sahyogsuchi_list.html"><h4 style="color:blue;text-align:center;">(सहयोग 33 से 104 तक)</h4></a>-->
                <!--    <a href="new_sahyogsuchi_list.html"><h6 style="text-align:center;animation: animate -->
                <!--1.5s linear infinite;">Click Here</h6></a>-->
                <!--  </div>-->
                <!--  <div class="col-lg-1 col-md-0 col-sm-1">-->
                <!--  </div>-->
                <!--  <div class="col-lg-2 col-md-3 col-sm-3" style="border:2px solid red; padding: 5px; box-shadow: 2px 3px 8px 3px red; margin-bottom:25px;">-->
                <!--    <a href="latest_sahyogsuchi_list.html"><h2 style="color:blue;text-align:center;">सहयोग सूची</h2></a>-->
                <!--    <a href="latest_sahyogsuchi_list.html"><h4 style="color:blue;text-align:center;">(सहयोग 105 से 132)</h4></a>-->
                <!--    <a href="latest_sahyogsuchi_list.html"><h6 style="text-align:center;animation: animate -->
                <!--1.5s linear infinite;">Click Here</h6></a>-->
                <!--  </div>-->
                  <div class="col-lg-1 col-md-0 col-sm-1">
                  </div>
                  <div class="col-lg-2 col-md-3 col-sm-3" style="border:2px solid red; padding: 5px; box-shadow: 2px 3px 8px 3px red; margin-bottom:25px;">
                    <a href="updated_sahyogsuchi_list.html"><h2 style="color:blue;text-align:center;">सहयोग सूची</h2></a>
                    <a href="updated_sahyogsuchi_list.html"><h4 style="color:blue;text-align:center;">(सहयोग 133 से अब तक)</h4></a>
                    <a href="updated_sahyogsuchi_list.html"><h6 style="text-align:center;animation: animate 
                1.5s linear infinite;">Click Here</h6></a>
                  </div>
                  <div class="col-lg-1 col-md-0 col-sm-1">
                  </div>
                  <div class="col-lg-2 col-md-3 col-sm-3" style="border:2px solid red; padding: 5px; box-shadow: 2px 3px 8px 3px red; margin-bottom:25px;">
                    <a href="updated_name_wise_sahyog_list.html"><h2 style="color:blue;text-align:center;">सहयोग सूची</h2></a>
                    <a href="updated_name_wise_sahyog_list.html"><h4 style="color:blue;text-align:center;">(दिवंगत शिक्षकवार सहयोग)</h4></a>
                    <a href="updated_name_wise_sahyog_list.html"><h6 style="text-align:center;animation: animate 
                1.5s linear infinite;">Click Here</h6></a>
                  </div>
                  <div class="col-lg-1 col-md-0 col-sm-1" style="margin-bottom:50px;">
                  </div>
                </div>
              </div>
        ...
        </div> <br><a href="https://api.whatsapp.com/send?phone=+917007087337&text=Hello TSCT" class="btn-whatsapp-pulse" target="_blank" style="z-index:1000">
